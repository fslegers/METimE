...
def calc_constraints_errors(lambdas, state_variables, scaling_component = 1):
    """
...
def perform_optimization(guesses, state_variables, scaling_component=1):
    ...
    for initial_guess in guesses[0:min(len(guesses), 4)]:
        ...
        #                    method='SLSQP',
        #                    options={'eps': 1e-11, 'ftol':1e-6, 'disp':True},
        ...
        sol = minimize(objective_function,
                       ...
                       args=(state_variables, ),
                          ...
                          method="trust-constr",
                          options={'initial_tr_radius': 0.01,
                                   'gtol': 1e-10,
                                   'xtol': 1e-10,
                                   'disp': True,
                                   'verbose': 3
