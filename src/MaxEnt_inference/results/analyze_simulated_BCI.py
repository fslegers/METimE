...
def metrics_per_slack_weight(df, frac):
    ...
    # --- Bottom subplot: AIC ---
    for census, group in df.groupby("iter"):
        color = census_colors[iter]
...
def cleaner_look(df):
    ...
    # Figure-wide x-label
    fig.text(0.5, 0.05, "Fraction of population removed", ha='center', fontsize=16)
    fig.text(0.5, 0.95, "Metric", ha='center', fontsize=20)
...
if __name__ == "__main__":
    ...
    diff = df['METimE_MAE'] - df['METE_MAE']
